...
func insert(nod *net.UDPAddr, data string) {

  conn, err := net.DialUDP("udp", nil, nod)
  checkError(err)
  var msg Message
  msg.Idx  = 9
  msg.Key  = sha1hash(data)
  msg.Info = data
  msg.Gen  = 0
  msg.Src  = nil
  msg.Dst  = nod
...
func get(nod *net.UDPAddr, data string) {
...
func update(nod *net.UDPAddr) {
}

func delete(nod *net.UDPAddr, data string) {
