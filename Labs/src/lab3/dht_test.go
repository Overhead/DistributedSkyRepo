...
fmt.Println("Create node 3")
  node3 := makeDHTNode(nil, "localhost", "1113")
fmt.Println("Create node 4")
  node4 := makeDHTNode(nil, "localhost", "1114")
fmt.Println("Create node 5")
  node5 := makeDHTNode(nil, "localhost", "1115")
fmt.Println("Create node 6")
  node6 := makeDHTNode(nil, "localhost", "1116")
fmt.Println("Create node 7")
  node7 := makeDHTNode(nil, "localhost", "1117")
fmt.Println("Create node 8")
  node8 := makeDHTNode(nil, "localhost", "1118")
fmt.Println("Create node 9")
  node9 := makeDHTNode(nil, "localhost", "1119")
fmt.Println("Ready creating")
time.Sleep(5000 * time.Millisecond)

fmt.Println("add node 2")
  addToRing(node1, node2)
fmt.Println("add node 3")
  addToRing(node1, node3)
fmt.Println("add node 4")
  addToRing(node1, node4)
fmt.Println("add node 5")
  addToRing(node4, node5)
fmt.Println("add node 6")
  addToRing(node3, node6)
fmt.Println("add node 7")
  addToRing(node3, node7)
fmt.Println("add node 8")
  addToRing(node3, node8)
fmt.Println("add node 9")
...
time.Sleep(5000 * time.Millisecond)
  ...
  str2 := "Goodbye students!" 
  hashKey2 := sha1hash(str2)
  fmt.Println("str=" + str2)
  fmt.Println("hashKey2=" + hashKey2)

  fmt.Println("node 1: ")
  lookup(node1, hashKey)
  time.Sleep(5000 * time.Millisecond)
  fmt.Println(" is respoinsible for " + hashKey)


  fmt.Println("node 5: ")
  lookup(node5, hashKey)
  time.Sleep(5000 * time.Millisecond)
  fmt.Println(" is respoinsible for " + hashKey)
