...
func TestLookup(t *testing.T) {
  ...
  fmt.Println("node 1: " + node1.lookup(hashKey).nodeId + " is responsible for " + hashKey)
  fmt.Println("node 5: " + node5.lookup(hashKey).nodeId + " is responsible for " + hashKey)
...
func TestFLookup(t *testing.T) {
  ...
  nod, jmps := node1.fLookup(hashKey)
  fmt.Printf("node 1: %s is responsible for %s jumps: %d\n",
      nod.nodeId, hashKey, jmps)
  nod, jmps = node5.fLookup(hashKey)
  fmt.Printf("node 5: %s is responsible for %s jumps: %d\n",
      nod.nodeId, hashKey, jmps)

  fmt.Println("-------------------------------------------------------------------------------")

  nod, jmps = node1.mLookup(hashKey)
  fmt.Printf("node 1: %s is responsible for %s jumps: %d\n",
      nod.nodeId, hashKey, jmps)
  nod, jmps = node5.mLookup(hashKey)
  fmt.Printf("node 5: %s is responsible for %s jumps: %d\n",
      nod.nodeId, hashKey, jmps)

/*
  fmt.Println("node 1: " + node1.fLookup(hashKey).nodeId + " is responsible for " + hashKey)
  fmt.Println("node 5: " + node5.fLookup(hashKey).nodeId + " is responsible for " + hashKey)
*/
  fmt.Println("-------------------------------------------------------------------------------")
